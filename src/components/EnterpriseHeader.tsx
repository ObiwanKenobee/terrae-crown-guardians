          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="relative">
                <Crown className="h-10 w-10 text-green-700 group-hover:text-green-600 transition-colors" />
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-green-600 font-medium tracking-wider uppercase">
                  Regina Terrae
                </p>
              </div>
            </Link>
